...
export class NotificationsPartnerService {
  constructor(
    @InjectRepository(AdventureNotification)
    private readonly notificationRepo: Repository<AdventureNotification>,
    @InjectRepository(AdventureDeviceToken)
    private readonly tokenRepo: Repository<AdventureDeviceToken>,
    @InjectRepository(AdventureNotificationPreferences)
    private readonly prefsRepo: Repository<AdventureNotificationPreferences>,
