...
export class PackagePackageTier {
  ...
  @OneToMany(() => PackagePackageBenefit, (b) => b.package_tier, { cascade: true })
  benefits: PackagePackageBenefit[];
}
