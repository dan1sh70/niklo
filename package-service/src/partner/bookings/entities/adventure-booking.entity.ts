...
import { PackageBookingParticipant } from './adventure-booking-participant.entity';
import { PackageBookingInclusion } from './adventure-booking-inclusion.entity';
...
export class PackageBooking {
  ...
  @ManyToOne(() => PackageActivity, { onDelete: 'RESTRICT' })
  @JoinColumn({ name: 'activity_id' })
  activity: PackageActivity;

  @OneToMany(() => PackageBookingParticipant, (p) => p.booking, { cascade: true })
  participants: PackageBookingParticipant[];

  @OneToMany(() => PackageBookingInclusion, (i) => i.booking, { cascade: true })
  inclusions: PackageBookingInclusion[];
}
