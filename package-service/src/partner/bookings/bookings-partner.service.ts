...
export class BookingsPartnerService {
  constructor(
    ...
    @InjectRepository(PackageBookingParticipant)
    private readonly participantRepo: Repository<PackageBookingParticipant>,
    @InjectRepository(PackageBookingInclusion)
    private readonly inclusionRepo: Repository<PackageBookingInclusion>,
